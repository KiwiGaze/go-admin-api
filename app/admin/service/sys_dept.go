...
// Get retrieves a SysDept object.
func (e *SysDept) Get(d *dto.SysDeptGetReq, model *models.SysDept) error {
	...
	if model.DeptId == 0 {
		err = errors.New("the requested record does not exist or you do not have permission to view it")
...
// Insert creates a SysDept object.
...
// Update updates a SysDept object.
...
// Remove deletes a SysDept object.
func (e *SysDept) Remove(d *dto.SysDeptDeleteReq) error {
	...
	if db.RowsAffected == 0 {
		err = errors.New("you do not have permission to delete this data")
		return err
	}
	return nil
}

// GetSysDeptList retrieves department data.
...
// SetDeptTree builds the department tree.
...
// Call recursively builds department data.
...
// SetDeptPage builds department page data.
...
// GetWithRoleId retrieves the department ID set for a role.
